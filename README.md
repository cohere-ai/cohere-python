...
## Models
To view an up-to-date list of available models please consult the models section in the [platform](https://os.cohere.ai). To get started try out `large` for Generate, Choose Best, and Classify or `small` for Embed.
