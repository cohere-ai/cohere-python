...
class TestClassify(unittest.TestCase):
    def test_success(self):
        ...
        self.assertIsInstance(prediction.classifications[0].confidence[0].value, (int, float))
        self.assertIsInstance(prediction.classifications[0].confidence[0].label, str)
        self.assertIsInstance(prediction.classifications[0].confidence[1].value, (int, float))
