...
class TestClassify(unittest.TestCase):
    ...
    def test_success(self):
        ...
        print(prediction.classifications[0])
        ...
        self.assertTrue(prediction.classifications[0].meta)
        self.assertTrue(prediction.classifications[0].meta["api_version"])
        self.assertTrue(prediction.classifications[0].meta["api_version"]["version"])
