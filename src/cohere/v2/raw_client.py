...
class RawV2Client:
    ...
    def chat_stream(
        ...
        *,
    ...
    ) -> typing.Iterator[HttpResponse[typing.Iterator[StreamedChatResponseV2]]]:
        """
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            def _stream() -> HttpResponse[typing.Iterator[StreamedChatResponseV2]]:
                try:
...
class AsyncRawV2Client:
    ...
    async def chat_stream(
        ...
        *,
        ...
        tool_choice: typing.Optional[V2ChatStreamRequestToolChoice] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[AsyncHttpResponse[typing.AsyncIterator[StreamedChatResponseV2]]]:
        """
        Generates a text response to a user message. To learn how to use the Chat API and RAG follow our [Text Generation guides](https://docs.cohere.com/v2/docs/chat-api).
        ...
        async with self._client_wrapper.httpx_client.stream(
            ...
            async def _stream() -> AsyncHttpResponse[typing.AsyncIterator[StreamedChatResponseV2]]:
                try:
                    if 200 <= _response.status_code < 300:
