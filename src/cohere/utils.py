...
from . import EmbedResponse, EmbeddingsFloatsEmbedResponse, EmbedByTypeResponseEmbeddings, ApiMeta, \
...
def merge_embed_responses(responses: typing.List[EmbedResponse]) -> EmbedResponse:
    ...
    if responses[0].response_type == "embeddings_floats":
        ...
        embeddings_type = typing.cast(typing.List[EmbedByTypeResponseEmbeddings], responses)
        ...
        return EmbedByTypeResponseEmbeddings(
