...
class ConnectorsClient:
    ...
    def list(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                ListConnectorsResponse, construct_type(type_=ListConnectorsResponse, object_=_response.json())
            )
    ...
    def create(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                CreateConnectorResponse, construct_type(type_=CreateConnectorResponse, object_=_response.json())
            )
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
    ...
    def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetConnectorResponse:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                GetConnectorResponse, construct_type(type_=GetConnectorResponse, object_=_response.json())
            )
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
    ...
    def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DeleteConnectorResponse:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                DeleteConnectorResponse, construct_type(type_=DeleteConnectorResponse, object_=_response.json())
            )
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
        if _response.status_code == 403:
    ...
    def update(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                UpdateConnectorResponse, construct_type(type_=UpdateConnectorResponse, object_=_response.json())
            )
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
        if _response.status_code == 403:
    ...
    def o_auth_authorize(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                OAuthAuthorizeResponse, construct_type(type_=OAuthAuthorizeResponse, object_=_response.json())
            )
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
        if _response.status_code == 404:
