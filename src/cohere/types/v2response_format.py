...
class TextV2ResponseFormat(UncheckedBaseModel):
    """
...
class JsonObjectV2ResponseFormat(UncheckedBaseModel):
    """
    Configuration for forcing the model output to adhere to the specified format. Supported on [Command R](https://docs.cohere.com/docs/command-r), [Command R+](https://docs.cohere.com/docs/command-r-plus) and newer models.
...
V2ResponseFormat = typing_extensions.Annotated[
    typing.Union[TextV2ResponseFormat, JsonObjectV2ResponseFormat], UnionMetadata(discriminant="type")
]
