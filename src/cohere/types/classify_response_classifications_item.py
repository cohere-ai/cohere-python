...
class ClassifyResponseClassificationsItem(UncheckedBaseModel):
    ...
    predictions: typing.Optional[typing.List[str]] = pydantic.Field(default=None)
    """
    ...
    confidences: typing.Optional[typing.List[float]] = pydantic.Field(default=None)
    """
    An array containing the confidence scores of all the predictions in the same order
    """

    labels: typing.Optional[typing.Dict[str, ClassifyResponseClassificationsItemLabelsValue]] = pydantic.Field(
        default=None
    )
    """
    ...
    classification_type: typing.Optional[ClassifyResponseClassificationsItemClassificationType] = pydantic.Field(
        default=None
    )
    """
