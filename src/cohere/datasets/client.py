...
class DatasetsClient:
    ...
    def list(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                DatasetsListResponse, construct_type(type_=DatasetsListResponse, object_=_response.json())
            )
    ...
    def create(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                DatasetsCreateResponse, construct_type(type_=DatasetsCreateResponse, object_=_response.json())
            )
        if _response.status_code == 429:
            raise TooManyRequestsError(
                typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json()))
    ...
    def get_usage(self, *, request_options: typing.Optional[RequestOptions] = None) -> DatasetsGetUsageResponse:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                DatasetsGetUsageResponse, construct_type(type_=DatasetsGetUsageResponse, object_=_response.json())
            )
        if _response.status_code == 429:
            raise TooManyRequestsError(
                typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json()))
    ...
    def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DatasetsGetResponse:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(DatasetsGetResponse, construct_type(type_=DatasetsGetResponse, object_=_response.json()))
        if _response.status_code == 429:
            raise TooManyRequestsError(
                typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json()))
            )
    ...
    def delete(
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                typing.Dict[str, typing.Any],
                construct_type(type_=typing.Dict[str, typing.Any], object_=_response.json()),
            )
        if _response.status_code == 429:
            raise TooManyRequestsError(
                typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json()))
