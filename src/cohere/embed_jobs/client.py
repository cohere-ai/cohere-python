...
class EmbedJobsClient:
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> ListEmbedJobResponse:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                ListEmbedJobResponse, construct_type(type_=ListEmbedJobResponse, object_=_response.json())
            )
    ...
    def create(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(
                CreateEmbedJobResponse, construct_type(type_=CreateEmbedJobResponse, object_=_response.json())
            )
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
        if _response.status_code == 429:
    ...
    def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> EmbedJob:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(EmbedJob, construct_type(type_=EmbedJob, object_=_response.json()))
        if _response.status_code == 400:
            raise BadRequestError(typing.cast(typing.Any, construct_type(type_=typing.Any, object_=_response.json())))
