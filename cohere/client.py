...
class Client:
    ...
    Args:
        api_key (str): Your API key. If not specified, the client will use the value from the CO_API_KEY environment
            variable.
        ...
        api_url (str): override the default API url. If not specified, the client will use the value from the optional
            CO_API_URL environment variable or fall back to the default cohere.COHERE_API_URL.
    """
