...
from cohere.responses import (Classification, Classifications, Detokenization, Generations, Tokens)
...
from cohere.responses.generate_feedback import GenerateFeedback
    ...
    def _request(self, endpoint, json=None, method="POST") -> Any:
        ...
        with requests.Session() as session:
            ...
            try:
                ...
                raise CohereError(message="A Connection error occurred when trying to connect to the Cohere API."
                                  " Please check your internet connection.") from e
