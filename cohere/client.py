...
class Client:
    ...
    def _oci_request(self, endpoint, json=None, files=None, method="POST", stream=False, params=None) -> Any:
        ...
        with requests.Session() as session:
            ...
            if stream:
                return session.request(method, url, json=json, **self.request_dict, stream=True,
                                       auth=auth)
